...
//    }
    ...
    @Override
    public List<ProgramState> getListProgramState() {
...
//                logFile.println(entry.getKey() + "-->" + entry.getValue().toString());
            ...
            logFile.println(state.getLockTable().toString());
            logFile.println("----------------------------------------------------");
        }
        catch (IOException e) {
    ...
    @Override
    public void setProgramList(List<ProgramState> listProgramState) {
        programStateList = listProgramState;
    }
}
